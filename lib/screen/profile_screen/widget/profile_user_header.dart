...
import 'package:bubbly/common/manager/branch_io_manager.dart';
import 'package:bubbly/common/manager/session_manager.dart';
import 'package:bubbly/common/widget/custom_image.dart';
import 'package:bubbly/common/widget/custom_popup_menu_button.dart';
...
import 'package:bubbly/screen/follow_following_screen/follow_following_screen.dart';
import 'package:bubbly/screen/level_screen/level_screen.dart';
import 'package:bubbly/screen/profile_screen/profile_screen_controller.dart';
import 'package:bubbly/screen/profile_screen/widget/profile_preview_interactive_screen.dart';
import 'package:bubbly/screen/profile_screen/widget/user_link_sheet.dart';
import 'package:bubbly/screen/settings_screen/settings_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        // تم حذف زر Publish من هنا
        // زر الرسائل للمستخدمين الآخرين فقط
