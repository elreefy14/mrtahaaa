...
import 'package:bubbly/screen/auth_screen/forget_password_sheet.dart';
import 'package:bubbly/screen/auth_screen/registration_screen.dart';
                            ...
                            child: Column(
                              children: [
                                Container(
                                  ...
                                  child: TabBar(
                                    labelColor: whitePure(context),
                                    unselectedLabelColor: whitePure(context).withValues(alpha: .6),
                                    indicatorColor: whitePure(context),
                                    tabs: [
                                      Tab(text: LKey.email.tr),
                                      ...
                                      Column(
                                        children: [
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  color: whitePure(context).withValues(alpha: .1),
                                                  borderRadius: BorderRadius.circular(10),
                                                  border: Border.all(color: whitePure(context).withValues(alpha: .4)),
                                                ),
                                          ...
                                          Align(
                                            ...
                                            child: Text(
                                              'Tap the button to send code, then enter the OTP and tap again to verify.',
                                          ...
                                          const SizedBox(height: 14),
                                          TextButtonCustom(
                                            onTap: controller.onLoginWithPhone,
                                            title: LKey.logIn.tr,
                                            btnHeight: 50,
                                            horizontalMargin: 0,
                                          ),
