...
import 'package:bubbly/common/manager/haptic_manager.dart';
...
import 'package:bubbly/model/livestream/livestream_user_state.dart';
import 'package:bubbly/model/user_model/user_model.dart';
import 'package:bubbly/screen/gift_sheet/send_gift_sheet.dart';
import 'package:bubbly/screen/gift_sheet/send_gift_sheet_controller.dart';
import 'package:bubbly/screen/live_stream/live_stream_end_screen/live_stream_end_screen.dart';
import 'package:bubbly/screen/live_stream/live_stream_end_screen/widget/livestream_summary.dart';
import 'package:bubbly/screen/live_stream/livestream_screen/audience/widget/live_stream_join_sheet.dart';
import 'package:bubbly/screen/live_stream/livestream_screen/host/widget/live_stream_host_top_view.dart';
  ...
  void onCloseAudienceBtn() {
    ...
    Get.bottomSheet(ConfirmationSheet(
        ...
        onTap: () async {
          ...
          await logoutRoom();
          if (Get.isBottomSheetOpen == false && Get.isSnackbarOpen == false) {
            // Ensure we exit the livestream screen completely for audience
            if (Get.isOverlaysOpen) {
              // If any other overlays are present, close them first.
              Get.back();
            }
            Get.back();
          }
