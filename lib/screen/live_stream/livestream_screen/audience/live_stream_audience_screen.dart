// Updated LiveStreamAudienceScreen
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:keyboard_avoider/keyboard_avoider.dart';
import 'package:bubbly/model/livestream/livestream.dart';
import 'package:bubbly/screen/live_stream/livestream_screen/audience/widget/livestream_audience_top_view.dart';
import 'package:bubbly/screen/live_stream/livestream_screen/livestream_screen_controller.dart';
import 'package:bubbly/screen/live_stream/livestream_screen/view/battle_view.dart';
import 'package:bubbly/screen/live_stream/livestream_screen/view/live_stream_bottom_view.dart';
import 'package:bubbly/screen/live_stream/livestream_screen/view/live_video_player.dart';
import 'package:bubbly/screen/live_stream/livestream_screen/view/livestream_view.dart';
import 'package:bubbly/screen/live_stream/livestream_screen/widget/battle_start_countdown_overlay.dart';
...
import '../../GiftAnimationOverlay.dart';
      ...
      body: PopScope(
        ...
        child: Stack(
          children: [
            ...
            // إضافة نظام انيميشن الهدايا
            GiftAnimationOverlay(controller: controller),
