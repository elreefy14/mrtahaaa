class LKey {
  ...
  static const String cameraMicrophonePermissionTitle = 'camera_microphone_permission_title';
  static const String cameraMicrophonePermissionDescription = 'camera_microphone_permission_description';
  static const String initializingCamera = 'initializing_camera';
  static const String pleaseWait = 'please_wait';
  static const String tryAgain = 'try_again';
  static const String openSetting = 'open_setting';
  static const String cameraNotReady = 'camera_not_ready';
  static const String recordingFailed = 'recording_failed';
  static const String capturePhotoFailed = 'capture_photo_failed';
  static const String arCameraNotReady = 'ar_camera_not_ready';
  static const String failedToApplyFilter = 'failed_to_apply_filter';
  static const String cameraInitializing = 'camera_initializing';
  ...
  static const String searchHere = "Search";
  ...
  static var errorLoadingPayment="errorLoadingPayment";

  static var retry="retry";

  static var noCoinPackagesAvailable="noCoinPackagesAvailable";

  static var paymentSuccessful='suc';

  static var paymentFailed='paymentFailed';

  static var paymentCancelled='paymentCancelled';

  static var paymentSuccessfulButDataNotUpdated="paymentSuccessfulButDataNotUpdated";

  static var card3DSecureNotSupported='card3DSecureNotSupported';

  static var networkError='networkError';

  static var paymentProcessing='paymentProcessing';

  static var noOtherLivestreams="noOtherLivestreams";

  static var noOtherLivestreamsDescription='noOtherLivestreamsDescription';
