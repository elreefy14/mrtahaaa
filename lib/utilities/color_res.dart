...
class ColorRes {
  ...
  static const Color themeGradient1 = Color(0xFFFFD700);
  static const Color themeGradient2 = Color(0xFFFFC107);
  static const Color themeAccentSolid = Color(0xFF726B2E);
