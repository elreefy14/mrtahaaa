// common/service/utils/web_service.dart
...
class _GiftWallet {
  ...
  String verifyPayment = "${apiURL}misc/verifyPayment";

  String confirmPayment = "${apiURL}misc/verifyPayment"; // NEW: PayTabs verification endpoint
}
