...
import 'package:bubbly/model/post_story/comment/add_comment_model.dart';
import 'package:bubbly/model/post_story/comment/fetch_comment_model.dart';
import 'package:bubbly/model/post_story/comment/reply_comment_model.dart';
import 'package:bubbly/model/post_story/music/music_model.dart';
import 'package:bubbly/model/post_story/music/musics_model.dart';
import 'package:bubbly/model/post_story/post/explore_page_model.dart';
import 'package:bubbly/model/post_story/post/hashtag_post_model.dart';
import 'package:bubbly/model/post_story/post/posts_model.dart';
import 'package:bubbly/model/post_story/post_by_id.dart';
import 'package:bubbly/model/post_story/post_model.dart';
import 'package:bubbly/model/post_story/story/stories_model.dart';
import 'package:bubbly/model/post_story/story/story_model.dart';
import 'package:bubbly/model/post_story/user_post_model.dart';
...
class PostService {
  ...
  /// Add a voice (audio) comment by sending the audio file in the `comment`
  /// field of a multipart/form-data request. The backend rejects simply
  /// providing a path/URL for `type = 2`, so we must pass the raw file.
  Future<Comment?> addVoiceComment({
    required int postId,
    required XFile file,
    String? mentionUserIds,
  }) async {
    AddCommentModel model = await ApiService.instance.multiPartCallApi(
      url: WebService.post.addPostComment,
      param: {
        Params.postId: postId,
        Params.type: 2, // voice type
        if (mentionUserIds != null) Params.mentionedUserIds: mentionUserIds,
      },
      filesMap: {
        Params.comment: [file]
      },
