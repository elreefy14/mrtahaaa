...
class BranchIoManager {
  ...
  Future<CustomBranchResponse?> init(
    ...
    final branchObject = BranchUniversalObject(
      canonicalIdentifier: 'suplleex/${type.name}',
      title: shareData.title,
      imageUrl: shareData.imageUrl,
      keywords: ['suplleex', 'Flutter', 'Share'],
    ...
    switch (type) {
      case ShareBranchType.post:
        return BranchShareData(
          ...
          deepLinkUrl:
              'https://suplleex.app.link/post/${post?.id ?? ''}', // Update based on real URLs
        );
      ...
      case ShareBranchType.qr:
        return BranchShareData(
          ...
          deepLinkUrl:
              'https://suplleex.app.link/user/${user?.username ?? ''}', // Update based on real URLs
        );
    }
  }
